...
if __name__ == "__main__":
    ...
    show_video(best_stream, "Youtube Best Stream")

    # Show a selected stream
    stream_426_240 = video.videostreams[3]
    show_video(stream_426_240, "Youtube Stream with 426x240")